              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Mail className="absolute left-4 top-4 h-5 w-5 text-primary-500 group-focus-within:text-primary-600 transition-colors duration-200" />
                      <input
                        id="email"
                        name="email"
                        type="email"
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center group cursor-pointer">
                    <input
                      type="checkbox"
                      className="w-4 h-4 text-primary-600 bg-white border-neutral-300 rounded focus:ring-primary-500/20 focus:ring-2 transition-colors duration-200"
                    />
                    <span className="ml-3 text-sm text-text-muted group-hover:text-text-secondary transition-colors duration-200">
                      Remember me
                    </span>
                  </label>
                  <a
                    href="#"
                    className="text-sm font-semibold text-primary-600 hover:text-primary-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500/20 rounded-lg px-2 py-1"
                  >
                    Forgot password?
                  </a>
                </div>
